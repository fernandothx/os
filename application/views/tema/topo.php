...
<!--Header-part-->
<div id="header">
  <h1><a href="">Fernando Ricardo</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    ...
    <li class="pull-right"><a href="https://github.com/fernandothx/os" target="_blank"><i class="icon icon-asterisk"></i> <span class="text">Versão: <?php echo $this->config->item('app_version'); ?></span></a></li>
...
<!--Footer-part-->
<div class="row-fluid">
  <div id="footer" class="span12"> <a href="https://fernandothx.xyz" target="_blank"><?php echo date('Y'); ?> &copy; Fernando Ricardo </a></div>
</div>
<!--end-Footer-part-->
